<template>
  ...
  <div id="teaclassinform">
    ...
    <el-table id="teaclassinformtable" :data="tableData" >
        ...
        <el-table-column align="center" label="课程编号">
            <el-table-column align="center" width="120px" prop="courseNumber">
                <template #header>
  ...
  >
    ...
    >
        ...
        <!--                <el-row  v-for="(item, index) in ruleForm.arrangement" label="课时安排" :key="index" gutter="0">-->
        <!--                    <span>-->
        <!--                        <el-form-item   :prop="'arrangement[' + index + '].buildingId'" :rules="rule.arrangement">-->
        <!--                        <el-select v-model="ruleForm.arrangement[index].buildingId" prop="'buildingId'+index" placeholder="教学楼"  @change="getClassroom(index,ruleForm1.arrangement[index].buildingId)" style="margin:0">-->
        ...
        <!--                        <el-select v-model="ruleForm.arrangement[index].classroom" prop="'classroom'+index" placeholder="教室" value-key="classroomId">-->
        ...
        <!--                        <el-select v-model="ruleForm.arrangement[index].dayOfWeek" prop="'dayofweek'+index" placeholder="周几" >-->
        ...
        <!--                        <el-select v-model="ruleForm.arrangement[index].classTimeId" prop="'classTimeId'+index" placeholder="节次" multiple clearable >-->
        ...
        <el-form-item label="选课容量" prop="capacity">
            <el-input v-model="ruleForm.capacity" style="width: 220px"></el-input>
        </el-form-item>
